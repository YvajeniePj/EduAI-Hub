...
def convert_to_rubric_format(test_data: Dict) -> Dict:
    ...
    rubric = {
        ...
        "assignment_id": test_data.get("assignment_id", test_data.get("test_id", "")),
        "title": test_data["title"],
        "test_type": test_data["test_type"],  # Добавляем тип теста
        "questions": []
    }
    
    # Добавляем флаг AI-генерации, если есть
    if test_data.get("ai_generated"):
    ...
    for question in test_data["questions"]:
        if test_data["test_type"] == "keyword_based":
            ...
            rubric["questions"].append({
                ...
                "title": question.get("question_text", question.get("title", "")),
